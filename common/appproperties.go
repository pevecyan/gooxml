...
import (
	...
	"github.com/pevecyan/gooxml/schema/soo/ofc/extended_properties"
)
...
func NewAppProperties() AppProperties {
	...
	p.SetApplication("github.com/pevecyan/gooxml")
	p.SetDocSecurity(0)
...
// For gooxml created documents, it defaults to github.com/pevecyan/gooxml
